...
import { BadgeButton, BadgeButtonPending, BadgeButtonSuccess, CustomButton, DefaultButton } from '../reusable/button/Button'
import { DefaultInput, IconInput, OptionsSelect } from '../reusable/input/Input'
  ...
  return (
    <div>
      <h1 className='font-[500] text-[14px] mb-4'>
        To  verify your account for better transactions, Please provide the following information.
      </h1>
