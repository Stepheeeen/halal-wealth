    ...
    >
      ...
      <div className="w-[450px] h-[330px] bg-white rounded-lg shadow-lg absolute left-[30%] top-1/2 p-5 flex justify-between flex-col">
        <div className="grid w-full items-center text-center">
          <Image alt="home" src={Home} className="w-[50px] m-auto mt-2" />
          <h1 className="font-[600] text-[19px] my-[20px]">
            Skip BVN for later?
          </h1>
          <p>
            You won’t be able to perform transactions if you don’t provide us
            with your BVN. Do you still wish to proceed?
          </p>
        </div>
...
const CustomModal = ({
  ...
  return (
    <Modal isCentered onClose={onClose} isOpen={isOpen} size={""}>
      <ModalOverlay className="bg-black bg-opacity-50 z-20" />
      <div
        className={`w-[30%] h-[100vh] bg-white shadow-lg overflow-y-scroll fixed top-0 right-0 z-30 ${ModalStyling}`}
      >
        <header className="px-3 h-[70px] shadow-sm flex items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-[17px] ml-3 font-[500] text-[#14013A]">
              {modalTitle}
            </h1>
          </div>
        </header>
    ...
    >
      <div className="w-full h-[60vh] grid place-items-center">
        <div className="w-full grid place-items-center">
          <SuccessIcon />
          <h1 className="font-[550] text-xl text-center my-2 mt-5">
            NGN {amount} withdrawal successful
          </h1>
          <p className="text-center text-[14px] font-[450]">
            Your withdrawal of {amount} was successful and is processing. Thank
            you
          </p>
        </div>
      </div>
