...
import { BackIcon, CalenderIcon, Credit, Debit, FrontIcon, LikedIconPurple, TransactionStatus, WarningIcon } from '../../../public/assets/icons'
                    ...
                    <div key={i} className="p-3 shadow bg-[#FFFFFF] flex flex-col justify-center rounded">
                        <div className="flex justify-between items-center py-2">
                            ...
                            <div className="w-[85%] mx-1">
                                ...
                                <h1 className="text-[#5C556C] font-[450] text-[13px] flex items-center">
                                    ...
                                    <span className="text-[#17B26A] font-[600]">NGN {formatNumber(card.Amount)}</span>
                                </h1>
                            </div>

                            <p className="font-[500] text-[#14013A] text-[18px]">{percentage}%</p>
                        </div>
                        ...
                        >
                            ...
                            <div className='w-full relative py-3'>
                                <h1 className='text-[#14013A] font-[550] text-[18px]'>{card.AssetName}</h1>
                                <h1 className='text-[#8046F2] font-[570] my-1 text-[18px]'>NGN {formatNumber(card.Amount)}</h1>
                                <p className='text-[#5C556C] font-[450] text-[14px]'>Down payment: NGN {card.AmountPaid} <span className='text-[#5C556C]'>(6 months installment)</span></p>
                            ...
                            <div className='flex items-center justify-between '>
                                <div className='bg-[#ECF9F3] p-1 mt-3'>
                                    <div className='border border-[#8BD8B4] bg-[#ECF9F3] rounded-sm flex items-center p-1'>
                                        ...
                                        <div className="mr-1">
                                            ...
                                            <p className="text-sm font-[550] text-black mt-1">NGN {formatNumber(card.AmountPaid)}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='bg-[#F7E4E7] p-1 mt-3 '>
                                    <div className='border border-[#D7808F] bg-[#F7E4E7] rounded-sm flex items-center p-1'>
                                        ...
                                        <div className="mr-1 ">
                                            <h3 className="text-[13px] text-gray-600">Amount left to pay</h3>
                                            <p className="text-sm font-[550] text-black mt-1">NGN {formatNumber(card.AmountPaid)}</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='bg-[#F5F1FE] p-1 mt-3'>
                                <div className='border border-[#BFA2F8] bg-[#F5F1FE] rounded-sm flex items-center p-1'>
                                    ...
                                    <div className="mr-1 w-full flex items-start justify-between">
                                        <div>
                                            <h3 className="text-[13px] text-gray-600">Next payment date</h3>
                                            <p className="text-sm font-[550] text-black mt-[5px]">Dec 07, 2022</p>
                                        </div>

                                        <div>
                                            <h3 className="text-[13px] text-gray-600">Amount to pay</h3>
                                            <p className="text-sm font-[550] text-black mt-[5px]">NGN {formatNumber(card.AmountPaid)}</p>
