...
const SignIn = () => {
  ...
  return (
    ...
    >
        ...
        <IconInput value='password' size='lg' CustomStyle='mb-4' type={show ? 'text' : 'password'} icon={''} handleClick={handleClick} RighIcon={show ? <HideIcon /> : <ShowIcon />} label='Phone number' />
    </AuthContainer>
  )
}
