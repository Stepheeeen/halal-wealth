    ...
    <DashboardContainer PageTItle="Invest">
      <div className="w-full overflow-x-auto mt-2 whitespace-nowrap bg-white shadow-sm rounded-lg p-3">
        <div className="w-full overflow-x-auto mt-2 whitespace-nowrap bg-white shadow-sm rounded-lg p-3">
          ...
          <ChildCard
            CardTitle="My Investments"
            cardStyle="mt-[-7%] remove-shadow"
          >
          ...
          <ChildCard
            CardTitle="Create a new investment"
            cardStyle=" remove-shadow"
          >
              ...
              {investmentPlan.map((card, key) => (
                <div key={key} className="w-[32%]">
                  <CustomButton
                    ...
                    icon={""}
                    onClick={() => {
                      router.push("/dashboard/invest/balance/id");
                    }}
                    text={card.text}
                    type="solid"
              ...
              <div className="border border-[#8BD8B4] bg-[#ECF9F3] rounded-sm flex px-1 py-2">
                ...
                <div className="ml-2">
                  ...
                  <p className="text-sm text-gray-600">
                    You can’t withdraw until investment matures on{" "}
                    <strong className="font-[550] text-black">
                      Dec 07, 2022
                    </strong>
                  </p>
                </div>
