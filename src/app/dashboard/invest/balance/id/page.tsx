...
const Page = () => {
    ...
    return (
        <InvestContainer>
            <div>
                <Link href={'/dashboard/invest/balance'} className='flex items-center'>
            ...
            <div className="grid grid-cols-3 gap-col-4">
                {Card.map((cards, i) => (
                    <DefaultCard cardStyle='h-[150px] mt-[11px] p-2 w-[300px] border border-2 rounded-md' key={i}>
                        ...
                        <div className='flex items-center justify-between'>
                            <div>
                                <h1 className='text-[#17B26A] text-[17px] font-[600]'>{cards.rate}</h1>
