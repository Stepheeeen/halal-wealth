                ...
                <div className='mt-[20px] ml-3 w-[48%] bg-[#F9FAFB] p-3 rounded-lg'>
                    <div className='flex items-center justify-between'>
                        <div>
                            ...
                            <h1 className='font-[500] text-[18px]'>Lotus Halal Fixed Income Fund</h1>
                        </div>
                    ...
                    <div className='bg-[#ECF9F3] p-1 mt-3'>
                        <CustomButton ButtonStyling='' Context={''} childDiv='' customStyle='font-[500] py-5 border border-[#8BD8B4] bg-[#ECF9F3] rounded-sm ' icon={''} onClick={() => { }} text={<p className='text-[14px] font-[450]'>You can withdraw your investments at the maturity date</p>} title='' type='' />
                    </div>
